...
# shared GRPO hyperparams -- seq-mean edition
NORM_ADV=True
...
0)
    # Baseline: plain GRPO wager, no auxiliary losses
    EXP_NAME=grpo_wager_llama3.2-3b_exp5
    OUTPUT_DIR=/scratch/gpfs/DANQIC/jeff/llm-calibration/outputs/exp5/wager_baseline
    ...
    ;;
1)
    # Task 2: suppression loss
    EXP_NAME=grpo_wager_suppr_llama3.2-3b_exp5
    OUTPUT_DIR=/scratch/gpfs/DANQIC/jeff/llm-calibration/outputs/exp5/suppr_loss
    TRAIN_FILES=${DATA_DIR}/math_wager_detailed_train.parquet
    VAL_FILES=${DATA_DIR}/math_wager_detailed_val.parquet
    REWARD_FN=grpo_reward_wager
    SUPPR_COEF=0.02
    ...
    ;;
2)
    # Task 3: calibration loss
    EXP_NAME=grpo_wager_calib_llama3.2-3b_exp5
    OUTPUT_DIR=/scratch/gpfs/DANQIC/jeff/llm-calibration/outputs/exp5/calib_loss
    TRAIN_FILES=${DATA_DIR}/math_wager_detailed_train.parquet
    VAL_FILES=${DATA_DIR}/math_wager_detailed_val.parquet
    REWARD_FN=grpo_reward_wager
    SUPPR_COEF=0.0
    ...
    ;;
3)
    # Task 4: combined suppression + calibration loss
    EXP_NAME=grpo_wager_comb_llama3.2-3b_exp5
    OUTPUT_DIR=/scratch/gpfs/DANQIC/jeff/llm-calibration/outputs/exp5/comb_loss
    TRAIN_FILES=${DATA_DIR}/math_wager_detailed_train.parquet
    VAL_FILES=${DATA_DIR}/math_wager_detailed_val.parquet
    REWARD_FN=grpo_reward_wager
    SUPPR_COEF=0.02
    ...
    ;;
4)
    # Task 5: suppression loss, 2x coef
    EXP_NAME=grpo_wager_suppr2x_llama3.2-3b_exp5
    OUTPUT_DIR=/scratch/gpfs/DANQIC/jeff/llm-calibration/outputs/exp5/suppr_loss_2x
    TRAIN_FILES=${DATA_DIR}/math_wager_detailed_train.parquet
    VAL_FILES=${DATA_DIR}/math_wager_detailed_val.parquet
    REWARD_FN=grpo_reward_wager
    SUPPR_COEF=0.04
    ...
    ;;
5)
    # Task 6: calibration loss, 2x coef
    EXP_NAME=grpo_wager_calib2x_llama3.2-3b_exp5
    OUTPUT_DIR=/scratch/gpfs/DANQIC/jeff/llm-calibration/outputs/exp5/calib_loss_2x
    TRAIN_FILES=${DATA_DIR}/math_wager_detailed_train.parquet
    VAL_FILES=${DATA_DIR}/math_wager_detailed_val.parquet
    REWARD_FN=grpo_reward_wager
    SUPPR_COEF=0.0
    ...
    ;;
6)
    # Task 7: combined suppression + calibration loss, both 2x coef
    EXP_NAME=grpo_wager_comb2x_llama3.2-3b_exp5
    OUTPUT_DIR=/scratch/gpfs/DANQIC/jeff/llm-calibration/outputs/exp5/comb_loss_2x
    TRAIN_FILES=${DATA_DIR}/math_wager_detailed_train.parquet
    VAL_FILES=${DATA_DIR}/math_wager_detailed_val.parquet
    REWARD_FN=grpo_reward_wager
    SUPPR_COEF=0.04
