...
0)
    ...
    EXP_NAME=grpo_wager_llama3.2-3b_exp4
    OUTPUT_DIR=/scratch/gpfs/DANQIC/jeff/llm-calibration/outputs/exp4/wager_baseline
...
1)
    ...
    EXP_NAME=grpo_wager_suppr_llama3.2-3b_exp4
    OUTPUT_DIR=/scratch/gpfs/DANQIC/jeff/llm-calibration/outputs/exp4/suppr_loss
    TRAIN_FILES=${DATA_DIR}/math_wager_detailed_train.parquet
    VAL_FILES=${DATA_DIR}/math_wager_detailed_val.parquet
    REWARD_FN=grpo_reward_wager
    SUPPR_COEF=0.02
...
2)
    ...
    EXP_NAME=grpo_wager_calib_llama3.2-3b_exp4
    OUTPUT_DIR=/scratch/gpfs/DANQIC/jeff/llm-calibration/outputs/exp4/calib_loss
    TRAIN_FILES=${DATA_DIR}/math_wager_detailed_train.parquet
    VAL_FILES=${DATA_DIR}/math_wager_detailed_val.parquet
    REWARD_FN=grpo_reward_wager
    SUPPR_COEF=0.0
...
3)
    ...
    EXP_NAME=grpo_wager_comb_llama3.2-3b_exp4
    OUTPUT_DIR=/scratch/gpfs/DANQIC/jeff/llm-calibration/outputs/exp4/comb_loss
    TRAIN_FILES=${DATA_DIR}/math_wager_detailed_train.parquet
    VAL_FILES=${DATA_DIR}/math_wager_detailed_val.parquet
    REWARD_FN=grpo_reward_wager
    SUPPR_COEF=0.02
