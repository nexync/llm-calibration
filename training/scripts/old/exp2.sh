...
# shared GRPO hyperparams (best from Exp 1)
NORM_ADV=True
...
0)
    # Task 1: detailed prompt with verbal probability labels
    EXP_NAME=grpo_wager_detailed_llama3.2-3b_exp2
    OUTPUT_DIR=/scratch/gpfs/DANQIC/jeff/llm-calibration/outputs/exp2/detailed_prompt
    ...
    ;;
1)
    # Task 2: suppression loss -- penalise incorrect confidence declarations
    EXP_NAME=grpo_wager_suppr_llama3.2-3b_exp2
    OUTPUT_DIR=/scratch/gpfs/DANQIC/jeff/llm-calibration/outputs/exp2/suppr_loss
    ...
    ;;
2)
    # Task 3: calibration loss -- Gaussian soft target around empirical accuracy
    EXP_NAME=grpo_wager_calib_llama3.2-3b_exp2
    OUTPUT_DIR=/scratch/gpfs/DANQIC/jeff/llm-calibration/outputs/exp2/calib_loss
    TRAIN_FILES=${DATA_DIR}/math_wager_train.parquet
    VAL_FILES=${DATA_DIR}/math_wager_val.parquet
    REWARD_FN=grpo_reward_wager
    SUPPR_COEF=0.0
