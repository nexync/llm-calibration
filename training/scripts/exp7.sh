...
0)
    # calib only | LR=1e-6 | no decay
    EXP_NAME=grpo_wager_calib_llama3.2-3b_exp7
    OUTPUT_DIR=/scratch/gpfs/DANQIC/jeff/llm-calibration/outputs/exp7/calib
    LR=1e-6
    SUPPR_COEF=0.0; CALIB_COEF=0.002
    SUPPR_DECAY=0;  CALIB_DECAY=0
    ;;
1)
    # calib + suppr | LR=1e-6 | no decay
    EXP_NAME=grpo_wager_comb_llama3.2-3b_exp7
    OUTPUT_DIR=/scratch/gpfs/DANQIC/jeff/llm-calibration/outputs/exp7/comb
    LR=1e-6
    SUPPR_COEF=0.02; CALIB_COEF=0.002
    SUPPR_DECAY=0;   CALIB_DECAY=0
    ;;
2)
    # calib only | LR=2e-6 | no decay
    EXP_NAME=grpo_wager_calib_lr2x_llama3.2-3b_exp7
    OUTPUT_DIR=/scratch/gpfs/DANQIC/jeff/llm-calibration/outputs/exp7/calib_lr2x
    LR=2e-6
    SUPPR_COEF=0.0; CALIB_COEF=0.002
    SUPPR_DECAY=0;  CALIB_DECAY=0
    ;;
3)
    # calib + suppr | LR=2e-6 | no decay
    EXP_NAME=grpo_wager_comb_lr2x_llama3.2-3b_exp7
    OUTPUT_DIR=/scratch/gpfs/DANQIC/jeff/llm-calibration/outputs/exp7/comb_lr2x
    LR=2e-6
    SUPPR_COEF=0.02; CALIB_COEF=0.002
    SUPPR_DECAY=0;   CALIB_DECAY=0
    ;;
4)
    # calib only | LR=2e-6 | decay=200
    EXP_NAME=grpo_wager_calib_lr2x_decay200_llama3.2-3b_exp7
    OUTPUT_DIR=/scratch/gpfs/DANQIC/jeff/llm-calibration/outputs/exp7/calib_lr2x_decay200
    LR=2e-6
    SUPPR_COEF=0.0; CALIB_COEF=0.002
    SUPPR_DECAY=0;  CALIB_DECAY=200
    ;;
5)
    # calib + suppr | LR=2e-6 | decay=200
    EXP_NAME=grpo_wager_comb_lr2x_decay200_llama3.2-3b_exp7
    OUTPUT_DIR=/scratch/gpfs/DANQIC/jeff/llm-calibration/outputs/exp7/comb_lr2x_decay200
    LR=2e-6
    SUPPR_COEF=0.02; CALIB_COEF=0.002
    SUPPR_DECAY=200; CALIB_DECAY=200
    ;;
*)
