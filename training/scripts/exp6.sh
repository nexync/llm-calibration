...
0)
    ...
    EXP_NAME=grpo_standard_llama3.2-3b_exp6
    OUTPUT_DIR=/scratch/gpfs/DANQIC/jeff/llm-calibration/outputs/exp6/standard_baseline
...
1)
    ...
    EXP_NAME=grpo_wager_llama3.2-3b_exp6
    OUTPUT_DIR=/scratch/gpfs/DANQIC/jeff/llm-calibration/outputs/exp6/wager_baseline
...
2)
    ...
    EXP_NAME=grpo_wager_calib_decay30_llama3.2-3b_exp6
    OUTPUT_DIR=/scratch/gpfs/DANQIC/jeff/llm-calibration/outputs/exp6/calib_loss_decay30
    TRAIN_FILES=${DATA_DIR}/math_wager_detailed_train.parquet
    VAL_FILES=${DATA_DIR}/math_wager_detailed_val.parquet
    REWARD_FN=grpo_reward_wager
    SUPPR_COEF=0.0
...
3)
    ...
    EXP_NAME=grpo_wager_suppr_llama3.2-3b_exp6
    OUTPUT_DIR=/scratch/gpfs/DANQIC/jeff/llm-calibration/outputs/exp6/suppr_loss
    TRAIN_FILES=${DATA_DIR}/math_wager_detailed_train.parquet
    VAL_FILES=${DATA_DIR}/math_wager_detailed_val.parquet
    REWARD_FN=grpo_reward_wager
    SUPPR_COEF=0.01
...
4)
    ...
    EXP_NAME=grpo_wager_comb_calibdecay30_llama3.2-3b_exp6
    OUTPUT_DIR=/scratch/gpfs/DANQIC/jeff/llm-calibration/outputs/exp6/comb_calibdecay30
    TRAIN_FILES=${DATA_DIR}/math_wager_detailed_train.parquet
    VAL_FILES=${DATA_DIR}/math_wager_detailed_val.parquet
    REWARD_FN=grpo_reward_wager
    SUPPR_COEF=0.01
